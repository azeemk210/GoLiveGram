...
const SEOHead: React.FC = () => {
  ...
  const description = 'Join 2.5M+ creators rewarding ₹500-₹5000/month on GoLiveGram. Go live, build community, and turn your passion into profit with multiple monetization streams. Download now!';
